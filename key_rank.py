...
def parse_args():
  parser = argparse.ArgumentParser(description='Generate 9-round key-rank statistics with neural distinguisher.')
  parser.add_argument('--start-exp', type=int, default=5, help='Start exponent i for n_blocks=2**i.')
  parser.add_argument('--end-exp', type=int, default=8, help='End exponent i (exclusive) for n_blocks=2**i.')
  return parser.parse_args()

if __name__ == '__main__':
  args = parse_args();
  test(args.start_exp,args.end_exp);
